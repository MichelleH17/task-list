<template>
  <section class="bg-gray-100 px-4 py-10 w-full md:w-md mx-auto my-12 rounded-xl shadow">
    <div class="container-xl lg:container m-auto">
      ...
      <form @submit.prevent="addTask" class="flex flex-col gap-1 max-w-sm m-auto">
        <label for="newTask" class="font-semibold">
          Task Name
        </label>
        <input type="text" id="newTask" name="newTask" v-model="newTask" class="bg-white border border-gray-200 rounded-md p-1 mb-3" />
